...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--limit", type=int, default=10, help="Items per page")
...
def main() -> None:
    ...
    records = fetch_posts(page=args.page, limit=args.limit)

    # Viết JSONL:
    # overwrite -> append=False
    # default -> append=True (để bạn có thể fetch nhiều page và nối)
    write_jsonl(out_path, records, append=not args.overwrite)
